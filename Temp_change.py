...
def set_info(temp_max, temp_min):
    ...
    interval = range/6
    temp_ranges = [[temp_min, temp_min + interval], [temp_min + interval + 1, temp_min + 2*interval], [temp_min + 2*interval + 1, temp_min + 3*interval], [temp_min + 3*interval + 1, temp_min + 4*interval], [temp_min + 4*interval, + 1,temp_min + 5*interval], [temp_min + 5*interval + 1, temp_min + 6*interval]]
...
image = ax.imshow(start_grid(), origin = 'upper', cmap=cmap)
